...
/**
 * Dependency resolution helpers used by the extracted AOT mojos.
 */
@Singleton
public final class AotDependencyResolutionService {
    ...
    @Inject
    public AotDependencyResolutionService(MavenSession mavenSession,
    ...
    public List<ArtifactResult> artifactResultsFor(Stream<Artifact> artifacts, boolean applyManagedDependencies) throws DependencyResolutionException {
        ...
        if (applyManagedDependencies) {
            ...
            for (org.apache.maven.model.Dependency dependency : dependencies) {
                ...
                dependencyMap.putIfAbsent(ga, new Dependency(artifact, dependency.getScope(), Boolean.valueOf(dependency.getOptional())));
            }
