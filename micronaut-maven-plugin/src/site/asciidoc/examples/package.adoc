...
By default, the CRaC JDK used to build the image will be for the current system architecture and Java 21.
...
NOTE: Currently only Java 21, and `amd64` and `aarch64` architectures are supported.
