...
public class AbstractRunMojo extends AbstractMojo {
    ...
    @Inject
    public AbstractRunMojo(MavenProject mavenProject, MavenSession mavenSession, BuildPluginManager pluginManager,
    ...
    private void runApplication() throws Exception {
        String classpathArgument = this.classpath;
        if (addClasses) {
            classpathArgument = new File(targetDirectory, "classes" + File.pathSeparator).getAbsolutePath() + classpathArgument;
        }
